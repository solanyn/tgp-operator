# Talos GPU Provisioner — Design Document
...
The Talos GPU Provisioner is a Kubernetes-native operator designed to enable ephemeral, cost-efficient GPU provisioning for Talos Linux clusters across multiple affordable cloud providers. It targets users ranging from homelabs to startups and small businesses who require flexible GPU capacity for bursty workloads.
